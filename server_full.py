...
if __name__ == "__main__":
    import os
    import uvicorn
    # Render (and similar platforms) inject the PORT env var.
    # Use uvicorn.run(app, ...) to avoid a second import pass ("module:app")
    # which can delay startup and prevent port detection.
